import "../assets/CSS_JS/Services.css";
...
const Services = () => {
  ...
  // Charger tous les artisans puis filtrer ceux en "Services"
  useEffect(() => {
    setLoading(true);
    fetch(`http://localhost:5000/api/Artisans?categorie=Services`)
      .then((res) => {
      ...
      .then((data) => {
        ...
        const filtered = normalized.filter((a) => {
          ...
          return cat.trim().toLowerCase() === "services";
        });
  ...
  return (
    <div className="App">
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Cette page est dédiée aux artisans et ou entreprises dans le domaine des Services"
        />
        <meta
          name="keywords"
      ...
      <main>
        <h1 className="titre-principal">Artisans du domaine Services</h1>
        {loading ? (
          <p>Chargement…</p>
        ) : artisans.length === 0 ? (
