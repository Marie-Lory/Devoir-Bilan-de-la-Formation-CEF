import "../assets/CSS_JS/Donnees_personnelles.css";
      ...
      {/* ✅ Balises SEO dynamiques */}
        <Helmet>
          <title>Trouve ton artisan - Trouvez un professionnel de qualité</title>
            ...
            <meta
               name="keywords"
              content="artisan, trouver artisan, bâtiment, alimentation, fabrication, services, professionnels, Données personnelles, France"
            />
...
export default Données_personnelles;