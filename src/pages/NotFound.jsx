import "../assets/CSS_JS/NotFound.css";
...
const NotFound = () => {
  ...
  return (
    <div className="App">
      {/* ✅ Balises SEO dynamiques */}
        <Helmet>
          <title>Trouve ton artisan - Trouvez un professionnel de qualité</title>
            <meta
               name="description"
               content="Cette page s'affiche si vous avez rechercher un élément qui n'existe pas sur ce site"
            />
      ...
      <main>
        <div>
          <h1 className="titre-principal">Page non trouvée</h1>
        </div>
      </main>
